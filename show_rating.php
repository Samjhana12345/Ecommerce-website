...
<div class="container">		
	...
	foreach($itemDetails as $books){
		$average = $rating->getRatingAverage($books["id"]);
	?>	
	<div class="row">
		<div class="col-sm-2" style="width:150px">
			<img class="product_image" src="./src/uploads/<?php echo $books["image"]; ?>" style="width:100px;height:200px;padding-top:10px;">
		</div>
		<div class="col-sm-4">
			<h4 style="margin-top:10px;"><?php echo $books["title"]; ?></h4>
			<div><span class="average"><?php printf('%.1f', $average); ?> <small>/ 5</small></span> <span class="rating-reviews"><a href="show_rating.php?item_id=<?php echo $books["id"]; ?>">Rating & Reviews</a></span></div>
			<?php echo $books["description"]; ?>				
		</div>		
	</div>
	<?php } ?>	
	...
	<div id="ratingDetails"> 		
		<div class="row">			
			...
			<div class="col-sm-3">
				<button type="button" id="rateProduct" class="btn btn-info <?php if(!empty($_SESSION['id']) && $_SESSION['id']){ echo 'login';} ?>">Rate this product</button>
			</div>		
		</div>
		<div class="row">
		<div class="col-sm-7">
    ...
    <div class="review-block">
        ...
        foreach ($itemRating as $rating) {
            ...
            if (!in_array($rating['users'], $displayedReviews)) {
                $displayedReviews[] = $rating['users']; // Add this review to the displayed list
        ?>
                <div class="row">
                    <div class="col-sm-3">
                        <div class="review-block-name">user id By  <a href="#"><?php echo $rating['users']; ?></a></div>
			...
			<div class="col-sm-12">
				<form id="ratingForm" method="POST">					
					<div class="form-group">
						...
						<input type="hidden" class="form-control" id="books" name="books" value="<?php echo $_GET['item_id']; ?>">
